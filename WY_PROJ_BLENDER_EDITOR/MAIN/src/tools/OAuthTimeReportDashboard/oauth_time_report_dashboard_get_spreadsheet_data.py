...
def get_credentials(scopes, oauth_client_application_name, oauth_client_secret_json_file):
    ...
    Called by function: oauth_time_report_dashboard_get_spreadsheet_data::oauth_time_report_dashboard_get_spreadsheet_data()
    ------------------------------------------------------------------------
    Description:
    ------------------------------------------------------------------------
...
#===============================================================================
#===============================================================================
def oauth_time_report_dashboard_get_spreadsheet_data(google_spreadsheet_url, scopes,
    ...
    Called by function: oauth_time_report_dashboard_generator_generator::oauth_time_report_dashboard_generator_generator()
    ------------------------------------------------------------------------
    Description:
    ------------------------------------------------------------------------
    This function authenticates OAuth client with Google to get the access
